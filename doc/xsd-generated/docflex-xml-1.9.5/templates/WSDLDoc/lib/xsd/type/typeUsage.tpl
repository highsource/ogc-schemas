...
<ROOT>
  ...
  "all_locations", 
  toVector (findElementsByKey ("xsd-type-usage", contextElement.id))
)'
		FMT={
...
e.hasNext() ? {
  ...
  BooleanQuery (checkPredecessorByType("xs:attributeGroup"))
			...
			<ELEMENT_ITER>
				...
				TARGET_ET='wsdl:part'
				SCOPE='custom'
				ELEMENT_ENUM_EXPR='thisContext.getVar ("all_locations").toEnum()'
				SORTING='by-expr'
...
CHECKSUM='VWQFjDwDlfLp8oa7ksmXy7lf?SEd0wpgy2vO7GIFENw'
</DOCFLEX_TEMPLATE>