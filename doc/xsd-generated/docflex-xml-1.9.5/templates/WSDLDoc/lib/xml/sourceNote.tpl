...
<ROOT>
	<FOLDER>
		...
		<BODY>
			<FOLDER>
				COND='getBooleanParam("$remove.wsdl.docs") ||
getBooleanParam("$remove.xsd.anns")'
				FMT={
					txtfl.delimiter.text=', ';
				}
				<BODY>
					<AREA_SEC>
						...
						<AREA>
							<CTRL_GROUP>
								<CTRLS>
									<DATA_CTRL>
										FORMULA='(n = countElementsByLPath(".//wsdl:documentation")) > 0 ?
 "documentations (" + toString(n) + ")"
'
										FMT={
					...
					<AREA_SEC>
						COND='getBooleanParam("$remove.xsd.anns")'
						<AREA>
							<CTRL_GROUP>
								<CTRLS>
									<DATA_CTRL>
										FORMULA='(n = countElementsByLPath(".//xs:annotation")) > 0 ?
 "annotations (" + toString(n) + ")"
'
										FMT={
											ctrl.option.text.noBlankOutput='true';
										}
				...
				<AREA>
					<CTRL_GROUP>
						...
						<CTRLS>
							...
							<DATA_CTRL>
								FORMULA='findAncestor("xs:schema") != null ? "schema" : "WSDL"'
							</DATA_CTRL>
							<TEXT_CTRL>
								TEXT='source'
							</TEXT_CTRL>
...
CHECKSUM='ueynCEURWJXrp98LgT2XDopKIzKLblvKoGXEl8qxzvA'
</DOCFLEX_TEMPLATE>