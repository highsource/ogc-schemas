...
<TEMPLATE_PARAMS>
	...
	PARAM={
		param.name='$xmlName';
		param.description='Displayed XML name (qualified or local) of the binding';
		param.type='string';
	...
	PARAM={
		param.name='$title';
		param.title='Definition\'s doc title';
		param.type='string';
		param.defaultValue.expr='\'Binding "\' + getParam("$xmlName") + \'"\'';
	}
	PARAM={
		param.name='$portType';
		param.title='The portType that this binding binds';
		param.type='GOMElement';
		param.defaultValue.expr='findElementByKey (
  "wsdl-portTypes",
  ...
  BooleanQuery (checkElementByKey (
	...
	PARAM={
		...
		param.description='number of locations where this binding is used (referenced)';
		param.type='integer';
...
<ROOT>
	...
	<TEMPLATE_CALL>
		DESCR='Binding Profile / Extensibility Elements'
		COND='getBooleanParam("doc.wsdl.def.profile")
||
getBooleanParam("doc.wsdl.def.extensibility")'
		ON_OUTPUT_EXPR='thisContext.setVar ("has-profile", true)'
		TEMPLATE_FILE='bindingProfile.tpl'
		PASSED_PARAMS={
			'$extensibilityElements','getBooleanParam("doc.wsdl.def.extensibility")';
		}
	</TEMPLATE_CALL>
	<FOLDER>
		DESCR='Description'
...
&&
getBooleanParam("doc.wsdl.def.operationSummary.for.binding")'
...
setVar ("portTypeOperation", portTypeOperation);
...
(getBooleanParam("show.linkTitle.name") ?
  \' “\' + getAttrValue("name") + \'”\' : "")'
							...
							<TEMPLATE_CALL_CTRL>
								...
								PASSED_PARAMS={
									'$portTypeOperation','getElementVar ("portTypeOperation")';
									'$firstSentence','true';
								}
								FMT={
...
&&
getBooleanParam("doc.wsdl.def.xml.for.binding")'
		COLLAPSED
		<HTARGET>
			HKEYS={
				'contextElement.id';
...
&&
getBooleanParam("doc.wsdl.def.operations.for.binding")'
		STEP_EXPR='// find the corresponding portType operation
portTypeOperation = findElementByKey ("wsdl-bound-operations", contextElement.id);
...
setVar (
  ...
  portTypeOperation.callStockSection ("Operation Type")
		...
		<BODY>
			...
			<SS_CALL>
				SS_NAME='Operation'
				PARAMS_EXPR='Array (getVar ("portTypeOperation"))'
				FMT={
...
<STOCK_SECTIONS>
	...
	<FOLDER>
		SS_NAME='Operation'
		DESCR='param[0] - corresponding portType operation'
		...
		<BODY>
			<TEMPLATE_CALL>
				...
				TEMPLATE_FILE='operationDescription.tpl'
				PASSED_PARAMS={
					'$portTypeOperation','stockSection.param.toElement()';
				}
				STYLE_OVERRIDES={
					'Code','cs3';
				}
											...
											<CTRL_GROUP>
												<CTRLS>
													<SS_CALL_CTRL>
														...
														PASSED_ELEMENT_EXPR='stockSection.param.toElement()'
...
: ""'
													...
													<SS_CALL_CTRL>
														...
														PASSED_ELEMENT_EXPR='getElementParam("$portType")'
			...
			<FOLDER>
				...
				COND='getBooleanParam("doc.wsdl.def.operations.extensibility")'
				FMT={
			...
			<ELEMENT_ITER>
				DESCR='details of input / output / faults'
				CONTEXT_ELEMENT_EXPR='stockSection.param.toElement()'
				MATCHING_ET='wsdl:operation%wsdl:tOperation'
      ...
      getElementParam("$mainXML")
				...
				<BODY>
					<FOLDER>
						...
						INIT_EXPR='// input binding

name = getAttrValue("name");
nameFilter = (name != null) ? 
  BooleanQuery (hasAttrValue("name", name)) : null;

operationBinding = stockSection.contextElement;

stockSection.setVar (
  "inputBinding",
  operationBinding.findChild ("wsdl:input", nameFilter)
)'
						BREAK_PARENT_BLOCK='when-executed'
						COLLAPSED
						<BODY>
  ...
  thisContext.setVar (
    ...
    findElementByKey (
      ...
      mainXMLFilter
							...
							<FOLDER>
								COND='getBooleanParam("doc.wsdl.def.operations.input.extensibility")'
								CONTEXT_ELEMENT_EXPR='stockSection.getElementVar ("inputBinding")'
								MATCHING_ET='wsdl:input%wsdl:tBindingOperationMessage'
								FMT={
...
stockSection.setVar (
  "outputBinding",
  operationBinding.findChild ("wsdl:output", nameFilter)
)'
						BREAK_PARENT_BLOCK='when-executed'
						COLLAPSED
						<BODY>
  ...
  thisContext.setVar (
    ...
    findElementByKey (
      ...
      mainXMLFilter
							...
							<FOLDER>
								COND='getBooleanParam("doc.wsdl.def.operations.output.extensibility")'
								CONTEXT_ELEMENT_EXPR='stockSection.getElementVar ("outputBinding")'
								MATCHING_ET='wsdl:output%wsdl:tBindingOperationMessage'
								FMT={
									sec.spacing.before='5';
									sec.indent.block='true';
								}
...
stockSection.setVar (
  "faultBinding",
  operationBinding.findChild ("wsdl:fault", nameFilter)
)'
						COLLAPSED
						<BODY>
							<AREA_SEC>
  ...
  thisContext.setVar (
    ...
    findElementByKey (
      ...
      mainXMLFilter
							...
							<FOLDER>
								COND='getBooleanParam("doc.wsdl.def.operations.fault.extensibility")'
								CONTEXT_ELEMENT_EXPR='stockSection.getElementVar ("faultBinding")'
								MATCHING_ET='wsdl:fault%wsdl:tBindingOperationFault'
								FMT={
									sec.spacing.before='5';
									sec.indent.block='true';
								}
...
CHECKSUM='Arm0kI?pLd+IWekBCfnM9GHssgii?wnnDmX3mM60HYM'
</DOCFLEX_TEMPLATE>