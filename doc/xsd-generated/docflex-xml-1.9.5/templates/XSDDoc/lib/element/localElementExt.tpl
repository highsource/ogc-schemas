...
<ROOT>
	<AREA_SEC>
		...
		CONTEXT_ELEMENT_EXPR='countElementsByKey ("containing-elements", contextElement.id) == 1
 ? findElementByKey ("containing-elements", contextElement.id) : null'
...
CHECKSUM='ypMknT0ART37aPH7UHpKxY0hqNW15oetrf453I35Vl8'
</DOCFLEX_TEMPLATE>