...
local = getStringParam("doc.comp.contentElements.include.local");
  ...
  BooleanQuery ({
    ...
    (getAttrValue("name") != null ?  // case of local element
       local == "all" || local == "simpleType" && ! (
         ...
         findElementByKey ("element-types", contextElement.id).instanceOf("xs:%complexType")
       )
     :
...
: (refQName = getAttrQNameValue("ref")) != null ? 
  ...
  : callStockSection("Component Name")',ascending}
		SORTING_COND='getBooleanParam("doc.comp.contentElements.sorting")'
		FMT={
  ...
  stockSection.getQNameVar ("elementTypeQName")
						...
						<AREA>
							<CTRL_GROUP>
								<CTRLS>
									<TEMPLATE_CALL_CTRL>
										TEMPLATE_FILE='../component/simpleContentRep.tpl'
										PASSED_PARAMS={
											'$abbreviateEnum','getBooleanParam("doc.comp.contentElements.simpleContent.restrictions")';
						...
						<AREA>
							<CTRL_GROUP>
								<CTRLS>
									<SS_CALL_CTRL>
										SS_NAME='XML Rep'
										PARAMS_EXPR='Array (stockSection.contextElement)'
										FMT={
											ctrl.size.width='499.5';
											ctrl.size.height='17.3';
										}
							...
							<PANEL>
								...
								<AREA>
									<CTRL_GROUP>
										...
										<CTRLS>
											<TEXT_CTRL>
												COND='hasParamValue("doc.comp.contentElements.include.local", "all")
&&
findElementByType (
  iterator.items,
  "xs:%element",
  BooleanQuery (getAttrValue("name") != "")
											...
											<TEXT_CTRL>
												COND='hasParamValue("doc.comp.contentElements.include.local", "simpleType")
&&
findElementByType (
  iterator.items,
  "xs:%element",
...
! getBooleanParam("doc.comp.contentElements.xml")';
								...
								STYLE_OVERRIDES={
									'Derivation Tree Heading','s1';
									'Derivation Tree Method','cs4';
									'Derivation Tree Type','cs5';
								}
								FMT={
									ctrl.size.width='499.5';
									ctrl.size.height='17.3';
...
: "unknown") + " content"'
	...
	<TEMPLATE_CALL>
		...
		PASSED_PARAMS={
			...
			'$referenceComp','stockSection.param.toElement()';
			'$xmlContext','rootElement';
		}
		STYLE_OVERRIDES={
			'XML Rep','cs13';
			'XML Rep Attribute Name','cs14';
			'XML Rep Content Model','cs15';
			'XML Rep Heading','s7';
			'XML Rep Markup','cs16';
			'XML Rep Name','cs17';
			'XML Rep Value','cs18';
...
CHECKSUM='i?IzcYh?fcVY9FXp3T2HEPZf3pAYzxOkxT5dP9OUkFc'
</DOCFLEX_TEMPLATE>