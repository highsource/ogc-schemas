...
<schema xmlns="http://www.ascc.net/xml/schematron" defaultPhase="usingPhase" version="1.5" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="http://www.ascc.net/xml/schematron http://xml.ascc.net/schematron/schematron1-5.xsd">
	<title>Rules for WFS-1.1.0 TransactionResponse entities.</title>
	...
	<!-- ============================================================== -->
	<!-- Define the phase to be used in the ETS-->
	<!-- ============================================================== -->
	<!-- ============================================================== -->
	...
	<!-- ============================================================== -->
	<phase id="metaDataPropertyPhase">
		<active pattern="metaDataProperty_strict"/>
		<active pattern="metaDataProperty_extended"/>
	</phase>
	<phase id="alt_metaDataPropertyPhase">
		<active pattern="alt_metaDataProperty_strict"/>
		<active pattern="alt_metaDataProperty_extended"/>
	</phase>
	<phase id="ssp_metaDataPropertyPhase">
		<active pattern="ssp_metaDataProperty_strict"/>
		<active pattern="ssp_metaDataProperty_extended"/>
	</phase>
	<!-- ============================================================== -->
	...
	<!-- ============================================================== -->
	<phase id="usingPhase">
		<active pattern="using_strict"/>
		<active pattern="using_extended"/>
	</phase>
	<phase id="ssp_usingPhase">
		<active pattern="ssp_using_strict"/>
		<active pattern="ssp_using_extended"/>
	</phase>
	<phase id="lmb_usingPhase">
		<active pattern="lmb_using_strict"/>
		<active pattern="lmb_using_extended"/>
	</phase>
	<phase id="atm_usingPhase">
		<active pattern="atm_using_strict"/>
		<active pattern="atm_using_extended"/>
	</phase>
	<phase id="alt_usingPhase">
		<active pattern="alt_using_strict"/>
		<active pattern="alt_using_extended"/>
	</phase>
	<!-- ============================================================== -->
	...
	<!-- ============================================================== -->
	<phase id="acquisitionPhase">
		<active pattern="eop_acquisition_strict"/>
		<active pattern="eop_acquisition_extended"/>
	</phase>
	<phase id="sar_acquisitionPhase">
		<active pattern="sar_acquisition_strict"/>
		<active pattern="sar_acquisition_extended"/>
	</phase>
	<phase id="alt_acquisitionPhase">
		<active pattern="alt_acquisition_strict"/>
		<active pattern="alt_acquisition_extended"/>
	</phase>
	<phase id="atm_acquisitionPhase">
		<active pattern="atm_acquisition_strict"/>
		<active pattern="atm_acquisition_extended"/>
	</phase>
	<phase id="lmb_acquisitionPhase">
		<active pattern="lmb_acquisition_strict"/>
		<active pattern="lmb_acquisition_extended"/>
	</phase>
	<phase id="resultPhase">
		<active pattern="result_strict"/>
	</phase>
	<phase id="opt_resultPhase">
		<active pattern="result_strict"/>
		<active pattern="opt_result_strict"/>
	</phase>
	<phase id="atm_resultPhase">
		<active pattern="result_strict"/>
		<active pattern="atm_result_strict"/>
	</phase>
	<phase id="ssp_resultPhase">
		<active pattern="result_strict"/>
		<active pattern="ssp_result_strict"/>
	</phase>
	<phase id="eop_featureOfInterestPhase">
		<active pattern="eop_featureOfInterest"/>
	</phase>
	<phase id="alt_featureOfInterestPhase">
		<active pattern="alt_featureOfInterest"/>
	</phase>
	<phase id="lmb_featureOfInterestPhase">
		<active pattern="lmb_featureOfInterest"/>
	</phase>
	<phase id="ssp_featureOfInterestPhase">
		<active pattern="ssp_featureOfInterest"/>
	</phase>
	<phase id="validTimePhase">
		<active pattern="validTime_beginPosition"/>
		<active pattern="validTime_endPosition"/>
	</phase>
	<phase id="footprint_extentOfPhase">
		<active pattern="footprint_extentOf "/>
	</phase>
	<phase id="footprint_centerOfPhase">
