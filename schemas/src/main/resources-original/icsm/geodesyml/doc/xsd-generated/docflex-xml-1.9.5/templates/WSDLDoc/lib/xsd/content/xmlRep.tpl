...
<ROOT>
	<FOLDER>
		...
		CONTEXT_ELEMENT_EXPR='findElementByKey ("xsd-element-types", contextElement.id)'
    ...
    checkElementByKey (
      ...
      getElementParam("$mainXML")
			...
			<ELEMENT_ITER>
				...
				SCOPE='custom'
				ELEMENT_ENUM_EXPR='findElementsByKey (
  "xsd-content-model-attributes", contextElement.id
)'
				FMT={
					text.style='cs1';
				}
...
refAttr.hasAttr("default") ? refAttr :
  ...
  checkElementsByKey ("xsd-content-model-elements", contextElement.id) ? "complex"
  :
...
CHECKSUM='28xSr1AqvZ4i7HUn5seJCvrt4QQ2tImSzBqlsck3kIY'
</DOCFLEX_TEMPLATE>