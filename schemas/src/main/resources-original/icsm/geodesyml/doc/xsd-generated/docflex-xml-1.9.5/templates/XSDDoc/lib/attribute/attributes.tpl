...
setVar (
  ...
  : hasAttr("name")
    ...
    : getAttrQNameValue("ref").toXMLName (Array (rootElement, contextElement))',ascending}
		SORTING_COND='getBooleanParam("doc.comp.attributes.sorting")'
		FMT={
							...
							<CTRL_GROUP>
								<CTRLS>
									<TEMPLATE_CALL_CTRL>
										...
										PASSED_PARAMS={
											'$abbreviateEnum','getBooleanParam("doc.comp.attributes.value.restrictions")';
...
CHECKSUM='TYG8Ae9hoLNbwWPUj1LmLkYvm4oHv3TlQ5xxNGX02G4'
</DOCFLEX_TEMPLATE>