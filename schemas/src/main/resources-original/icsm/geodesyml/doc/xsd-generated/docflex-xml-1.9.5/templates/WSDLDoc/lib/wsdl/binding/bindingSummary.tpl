		...
		INIT_EXPR='output.format.supportsPageRefs ?
{
  ...
  thisContext.setVar ("showPageColumn", showPageColumn)
		...
		RULES={
			'#DOCUMENTS[hasParamValue("$scope", "any")] -> #DOCUMENT/wsdl:definitions';
			'#DOCUMENTS[hasParamValue("$scope", "namespace")] -> {findElementsByKey ("namespaces", getParam("$nsURI"))}::wsdl:definitions';
			'wsdl:definitions -> wsdl:binding',recursive;
		}
		SORTING='by-expr'
		SORTING_KEY={expr='callStockSection("WSDL Definition Name")',ascending}
		SORTING_COND='getBooleanParam("doc.frgm.wsdl.defs.sorting")'
		FMT={
			sec.outputStyle='table';
			table.sizing='Relative';
...
<STOCK_SECTIONS>
	<FOLDER>
		...
		<BODY>
			<TEMPLATE_CALL>
				...
				COND='hasParamValue("doc.frgm.wsdl.defs.description", "first_sentence")'
  ...
  "xs:annotation/xs:documentation//(#TEXT | #CDATA)"
			...
			<TEMPLATE_CALL>
				COND='getBooleanParam("doc.frgm.wsdl.defs.profile")'
				TEMPLATE_FILE='bindingProfile.tpl'
				PASSED_PARAMS={
					'$nsURI','findAncestor("wsdl:definitions").getAttrValue("targetNamespace")';
					'doc.wsdl.def.profile.namespace','getBooleanParam("doc.frgm.wsdl.defs.profile.namespace")';
					'doc.wsdl.def.profile.portType','getBooleanParam("doc.frgm.wsdl.defs.profile.portType")';
					'doc.wsdl.def.profile.includes','getBooleanParam("doc.frgm.wsdl.defs.profile.includes")';
					'doc.wsdl.def.profile.defined','getBooleanParam("doc.frgm.wsdl.defs.profile.defined")';
					'doc.wsdl.def.profile.used','getBooleanParam("doc.frgm.wsdl.defs.profile.used")';
				}
				FMT={
			...
			<TEMPLATE_CALL>
				...
				COND='hasParamValue("doc.frgm.wsdl.defs.description", "full")'
...
CHECKSUM='90f2LfoI0VJgdW0C3IYqw1qwZU0LxTpuq8rylkRSXiE'
</DOCFLEX_TEMPLATE>