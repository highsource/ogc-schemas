...
(hasServiceAttr ("redefinition") ?
  \' \' + callStockSection("redefinition") : "")';
	...
	PARAM={
		...
		param.type='integer';
		param.defaultValue.expr='countElementsByKey ("xsd-attributeGroup-usage", contextElement.id)';
		param.fixed='true';
		param.hidden='true';
	}
	PARAM={
		param.name='$contentModelKey';
		param.title='map key for "xsd-content-model-attributes"';
		param.description='The key for "xsd-content-model-attributes" map to find items associated with this component';
		param.type='Object';
...
getBooleanParam("doc.xsd.comp.xmlRep.for.attributeGroup")'
...
getBooleanParam("doc.xsd.comp.annotation.for.attributeGroup")'
		COLLAPSED
		<BODY>
			<TEMPLATE_CALL>
...
getBooleanParam("doc.xsd.comp.usage.for.attributeGroup")
&&
...
getBooleanParam("doc.xsd.comp.attributes.for.attributeGroup")'
...
CHECKSUM='gzh+pjbMwZpncir5dm3rIikQW2z4shfGua7UjEm4rwc'
</DOCFLEX_TEMPLATE>