...
<li>"wsdl_file" - WSDL file overview</li>
  ...
  "wsdl-definition-usage", contextElement.id
	...
	PARAM={
		param.name='$extensibilityElements';
		param.title='Show extensibility elements';
		param.type='boolean';
	}
	PARAM={
		...
		<BODY>
			<FOLDER>
				...
				<BODY>
					...
					<AREA_SEC>
						COND='getBooleanParam("doc.wsdl.def.profile.portType")'
						<AREA>
							<CTRL_GROUP>
								<CTRLS>
									<TEXT_CTRL>
									...
									<DATA_CTRL>
										...
										<DOC_HLINK>
											CONTEXT_ELEMENT_EXPR='getElementParam("$portType")'
...
&&
{
  count = countChildren("wsdl:operation");
  ...
  Array ("xml-source", "xml-source-location")
			...
			<AREA_SEC>
				COND='getBooleanParam("$extensibilityElements")
&&
checkStockSectionOutput("Extensibility Elements")'
				FMT={
				...
				<AREA>
					<CTRL_GROUP>
						...
						<CTRLS>
							...
							<PANEL>
								CONTEXT_ELEMENT_EXPR='contextElement.parent'
...
CHECKSUM='P5sVlzU8Y1Ve1TAMl2EEqFDbih1Hbd8DFegoFVAVm?I'
</DOCFLEX_TEMPLATE>