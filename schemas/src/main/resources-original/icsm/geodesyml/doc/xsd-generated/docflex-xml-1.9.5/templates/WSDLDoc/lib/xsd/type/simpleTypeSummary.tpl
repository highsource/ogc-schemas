				...
				<BODY>
					<TEMPLATE_CALL>
						...
						PASSED_PARAMS={
							...
							'doc.xsd.comp.profile.redefines','getBooleanParam("doc.frgm.xsd.comps.profile.redefines")';
							'doc.xsd.comp.profile.redefined','getBooleanParam("doc.frgm.xsd.comps.profile.redefined")';
...
CHECKSUM='aE6eLjs3PpfFd9RYTRYZRKa9FbJNDX4xdNF079QB1E4'
</DOCFLEX_TEMPLATE>