...
or declared locally';
		param.type='integer';
		param.defaultValue.expr='countElementsByKey ("xsd-element-usage", contextElement.id)';
		param.fixed='true';
		param.hidden='true';
	}
	PARAM={
...
getBooleanParam("doc.xsd.comp.xmlRep.for.element")'
...
name.charAt(0).toUpperCase() + name.substring(1) + \':\''
			...
			<AREA_SEC>
				COND='getBooleanParam("doc.xsd.comp.simpleContent.default")
&&
{
  ...
  countElementsByKey (
    ...
    defaultValue != null ?
    {
      ...
      true;
			...
			<AREA_SEC>
				COND='getBooleanParam("doc.xsd.comp.simpleContent.fixed")
&&
{
...
getIntParam("$elementCount") > 0'
			...
			<SS_CALL>
				...
				COND='getBooleanParam("doc.xsd.comp.lists.containingElements") &&
{
  e = findElementsByKey ("xsd-containing-elements", contextElement.id);
  ...
  thisContext.getVar ("elements")
			...
			<SS_CALL>
				...
				COND='getBooleanParam("doc.xsd.comp.lists.substitutableElements")
&&
getAttrValue("substitutionGroup") != null &&
{
  e = findElementsByKey ("xsd-substitution-group-heads", contextElement.id);
  ...
  thisContext.getVar ("elements")
			...
			<SS_CALL>
				...
				COND='getBooleanParam("doc.xsd.comp.lists.substitutingElements")
&&
instanceOf("xs:element") &&
{
  e = findElementsByKey ("xsd-substitution-group-members", contextElement.id);
  ...
  thisContext.getVar ("elements")
			...
			<SS_CALL>
				...
				COND='getBooleanParam("doc.xsd.comp.lists.childrenBySubst") &&
{
  e = findElementsByKey ("xsd-children-by-substitutions", contextElement.id);
  ...
  thisContext.getVar ("elements")
			...
			<SS_CALL>
				...
				COND='getBooleanParam("doc.xsd.comp.lists.parentsBySubst")
&&
getAttrValue("substitutionGroup") != null &&
{
  e = findElementsByKey ("xsd-parents-by-substitutions", contextElement.id);
...
&&
getBooleanParam("doc.xsd.comp.usage")'
		COLLAPSED
		<BODY>
			<FOLDER>
				DESCR='case of global element'
				COND='getBooleanParam("doc.xsd.comp.usage.for.element.global")'
  ...
  true;
						...
						<BODY>
							<ELEMENT_ITER>
								...
								COND='hasParamValue("doc.xsd.comp.usage.layout", "flow")
||
...
findHyperTarget (Array (
  ...
  Array ("detail", "xml-source-location")
							...
							<ELEMENT_ITER>
								...
								COND='hasParamValue("doc.xsd.comp.usage.layout", "one_column")'
								BREAK_PARENT_BLOCK='when-executed'
								TARGET_ET='xs:%element'
								SCOPE='custom'
								ELEMENT_ENUM_EXPR='thisContext.getVar ("locations").toEnum()'
...
Array (
  ...
  "xsd-element-usage",
  contextElement.id,
  BooleanQuery (instanceOf ("wsdl:part"))
)'
						SORTING='by-expr'
						SORTING_KEY={expr='callStockSection("WSDL Message Part")',ascending,case_sensitive}
						<BODY>
							<AREA_SEC>
			...
			<FOLDER>
				...
				COND='hasParamValue("doc.xsd.comp.usage.for.element.local", "always")
||
hasParamValue("doc.xsd.comp.usage.for.element.local", "multiple")
&&
getIntParam("$usageCount") > 1'
...
getBooleanParam("doc.xsd.comp.annotation.for.element")'
		COLLAPSED
		<BODY>
			<FOLDER>
...
print all annotations by definition locations'
  ...
  "local-annotations",
  findElementsByKey ("xsd-element-usage", contextElement.id),
  FlexQuery ({
...
(
  hasParamValue("doc.xsd.comp.type.for.element.type", "anonymous") &&
  getParam("$elementTypeQName") == null
  ||
  hasParamValue("doc.xsd.comp.type.for.element.type", "any")
)'
		CONTEXT_ELEMENT_EXPR='getElementParam("$elementType")'
		MATCHING_ETS={'xs:%complexType';'xs:%simpleType'}
		COLLAPSED
...
! getBooleanParam("doc.xsd.comp.xml")';
			...
			<TEMPLATE_CALL>
				COND='getBooleanParam("doc.xsd.comp.type.annotation")'
...
CHECKSUM='WMVNwP6F5khI3tP8qyPkihng7jVwBipWUMs6RLKYjPY'
</DOCFLEX_TEMPLATE>