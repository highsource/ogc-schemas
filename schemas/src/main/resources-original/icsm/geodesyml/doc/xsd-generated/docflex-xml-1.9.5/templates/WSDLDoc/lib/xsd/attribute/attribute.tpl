...
getBooleanParam("doc.xsd.comp.xmlRep.for.attribute")'
		ON_OUTPUT_EXPR='thisContext.setVar ("has-xml-rep-summary", true)'
		TEMPLATE_FILE='../content/xmlRep.tpl'
		PASSED_PARAMS={
			'$abbreviateAttrValue','getBooleanParam("doc.xsd.comp.simpleContent") &&
...
getBooleanParam("doc.xsd.comp.simpleContent.default")'
				<AREA>
					<CTRL_GROUP>
						<CTRLS>
							<TEXT_CTRL>
			...
			<AREA_SEC>
				COND='hasAttr("fixed") &&
getBooleanParam("doc.xsd.comp.simpleContent.fixed")'
				<AREA>
					<CTRL_GROUP>
						<CTRLS>
							<TEXT_CTRL>
...
getBooleanParam("doc.xsd.comp.usage.for.attribute")
&&
...
getBooleanParam("doc.xsd.comp.annotation.for.attribute")'
		COLLAPSED
		<BODY>
			<TEMPLATE_CALL>
...
(
  hasParamValue("doc.xsd.comp.type.for.attribute.type", "anonymous") &&
  getParam("$attrTypeQName") == null
  ||
  hasParamValue("doc.xsd.comp.type.for.attribute.type", "any")
)'
		CONTEXT_ELEMENT_EXPR='getParam("$attrType").toElement()'
		MATCHING_ET='xs:%simpleType'
		COLLAPSED
...
CHECKSUM='SPjuibjiJVygK4SUFdoqnHz28?wfRcSwJQ?w9mvuk4c'
</DOCFLEX_TEMPLATE>