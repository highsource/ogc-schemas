...
<ROOT>
 ...
 ? findElementByKey ("xsd-element-types", contextElement.id)
 : contextElement;'
...
checkElementsByKey ("xsd-content-model-elements", contextElement.id)'
						BREAK_PARENT_BLOCK='when-executed'
						<AREA>
							<CTRL_GROUP>
								<CTRLS>
...
CHECKSUM='LOzCbNUCndw7JE?dZCDE2wx4mVvcCKu2NQDT1chQQWQ'
</DOCFLEX_TEMPLATE>