...
try to link to its global documentation and, if not found, to its definition within the XML schema source'
  ...
  { 
    ...
    el = findElementByKey ("xsd-globally-documented-local-elements",
                           contextElement.id);
...
hasParamValue("doc.xsd.comp.diagram.links.element.local", "local")
...
hasParamValue("doc.xsd.comp.diagram.links.attribute.global", "local")
 ? keys.moveElement(0,2).toArray() : keys.toArray()';
										'keys = Vector (
  "detail",
  "local",
...
CHECKSUM='SNY5sdkNWgn0e9Uh7QlONd4KoG02IqBJELSXuKrLG1k'
</DOCFLEX_TEMPLATE>