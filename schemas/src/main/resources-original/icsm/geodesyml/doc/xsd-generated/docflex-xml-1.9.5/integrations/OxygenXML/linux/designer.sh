...
# spaces recognized as a single argument. Note that this command may be needed
# only for the generator invoked from the Template Designer (the designer itself
# never uses it).
#
