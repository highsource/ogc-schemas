...
findElementByKey ("globally-documented-local-elements", contextElement.id)'
									MATCHING_ET='xs:%localElement'
									TITLE_EXPR='getBooleanParam("show.linkTitle") ?
  callStockSection("Element Link Title") : ""'
									HKEYS={
  ...
  callStockSection("Element Link Title") : ""'
	...
	<TEMPLATE_CALL>
		...
		PASSED_PARAMS={
			'gen.doc.element.local.unifyByType','false
...
CHECKSUM='ApFnbpq?UQEpCNOenFhf+61ILVyxrhYdCS+a8sGMPhQ'
</DOCFLEX_TEMPLATE>