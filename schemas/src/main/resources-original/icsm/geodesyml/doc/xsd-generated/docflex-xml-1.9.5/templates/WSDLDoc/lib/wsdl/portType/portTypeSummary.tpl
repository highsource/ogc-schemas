		...
		INIT_EXPR='output.format.supportsPageRefs ?
{
  ...
  thisContext.setVar ("showPageColumn", showPageColumn)
		...
		RULES={
			...
			'wsdl:definitions -> wsdl:portType',recursive;
		}
		SORTING='by-expr'
...
CHECKSUM='NtE?0h12xdEQP5D9F9GW6nyph04pdQRzk2iBMhP5w2M'
</DOCFLEX_TEMPLATE>