...
DSM_TYPE_ID='wsdldoc'
ROOT_ET='wsdl:operation%wsdl:tBindingOperation'
<TEMPLATE_PARAMS>
	PARAM={
		param.name='$mainXML';
	...
	PARAM={
		param.name='$portTypeOperation';
		param.description='corresponding portType operation';
		param.type='GOMElement';
	}
	PARAM={
...
<ROOT>
	<SS_CALL>
		DESCR='if this binding operation has its own documentation'
		BREAK_PARENT_BLOCK='when-output'
		SS_NAME='WSDL Documentation'
	</SS_CALL>
	<FOLDER>
		DESCR='otherwise, switch to the corresponding portType operation'
		CONTEXT_ELEMENT_EXPR='getElementParam("$portTypeOperation")'
		MATCHING_ET='wsdl:operation%wsdl:tOperation'
		<BODY>
			<SS_CALL>
				DESCR='print doc of the corresponding portType operation'
				COND='getBooleanParam("doc.wsdl.def.altDesc.operation.copyFrom.portType.operation")'
				BREAK_PARENT_BLOCK='when-output'
				SS_NAME='WSDL Documentation'
			</SS_CALL>
			<SS_CALL>
				DESCR='copy from input message'
...
getBooleanParam("doc.wsdl.def.altDesc.operation.copyFrom.input.message.part.dataType")'
  ...
  getBooleanParam("doc.wsdl.def.altDesc.operation.copyFrom.input.message.part.dataType")
			...
			<SS_CALL>
				DESCR='copy from output message'
...
CHECKSUM='KN0SuOChAsA27efJBwuwyX28q4+iL9yWOh48xMVDAc4'
</DOCFLEX_TEMPLATE>